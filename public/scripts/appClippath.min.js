...
;// CONCATENATED MODULE: ./src/scripts/appClippath.js
function appClippath_typeof(obj) { "@babel/helpers - typeof"; return appClippath_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appClippath_typeof(obj); }
function appClippath_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appClippath_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appClippath_toPropertyKey(descriptor.key), descriptor); } }
function appClippath_createClass(Constructor, protoProps, staticProps) { if (protoProps) appClippath_defineProperties(Constructor.prototype, protoProps); if (staticProps) appClippath_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appClippath_toPropertyKey(arg) { var key = appClippath_toPrimitive(arg, "string"); return appClippath_typeof(key) === "symbol" ? key : String(key); }
function appClippath_toPrimitive(input, hint) { if (appClippath_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appClippath_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appClippath_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appClippath_assertThisInitialized(self); }
function appClippath_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppClippath = /*#__PURE__*/function (_Core) {
  _inherits(AppClippath, _Core);
  var _super = _createSuper(AppClippath);
  function AppClippath() {
    appClippath_classCallCheck(this, AppClippath);
    return _super.apply(this, arguments);
  }
  appClippath_createClass(AppClippath, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
