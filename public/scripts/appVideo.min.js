...
;// CONCATENATED MODULE: ./src/scripts/appVideo.js
function appVideo_typeof(obj) { "@babel/helpers - typeof"; return appVideo_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appVideo_typeof(obj); }
function appVideo_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appVideo_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appVideo_toPropertyKey(descriptor.key), descriptor); } }
function appVideo_createClass(Constructor, protoProps, staticProps) { if (protoProps) appVideo_defineProperties(Constructor.prototype, protoProps); if (staticProps) appVideo_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appVideo_toPropertyKey(arg) { var key = appVideo_toPrimitive(arg, "string"); return appVideo_typeof(key) === "symbol" ? key : String(key); }
function appVideo_toPrimitive(input, hint) { if (appVideo_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appVideo_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appVideo_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appVideo_assertThisInitialized(self); }
function appVideo_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppVideo = /*#__PURE__*/function (_Core) {
  _inherits(AppVideo, _Core);
  var _super = _createSuper(AppVideo);
  function AppVideo() {
    appVideo_classCallCheck(this, AppVideo);
    return _super.apply(this, arguments);
  }
  appVideo_createClass(AppVideo, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
    ...
    */
    ...
    value: function loadHandler() {
      ...
      var movCol = document.querySelector('.movCol');
      var areaH;
      var beforeH;
      var per;
      var nowTime = 0;
      mov.setAttribute('src', '../video/pixta_76524957.mp4');
      mov.addEventListener('loadeddata', function (e) {
        console.info(e);
        console.info(mov.duration);
        $('.loader').addClass('fo').on(_this.animationEnd, function () {
          $('.loader').addClass('hdn').off(_this.animationEnd);
      ...
      gsap.timeline({
        scrollTrigger: {
          ...
          // ここの数値で演出時間が決まる（スクロール距離=時間）
          scrub: 1,
          pin: true,
          //markers: true,
          onEnter: function onEnter() {
            areaH = ScrollTrigger_ScrollTrigger.maxScroll(window) /* - (movCol.getBoundingClientRect().top + window.pageYOffset) */;
