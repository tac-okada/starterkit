...
;// CONCATENATED MODULE: ./src/scripts/appScrolltriger.js
function appScrolltriger_typeof(obj) { "@babel/helpers - typeof"; return appScrolltriger_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appScrolltriger_typeof(obj); }
function appScrolltriger_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appScrolltriger_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appScrolltriger_toPropertyKey(descriptor.key), descriptor); } }
function appScrolltriger_createClass(Constructor, protoProps, staticProps) { if (protoProps) appScrolltriger_defineProperties(Constructor.prototype, protoProps); if (staticProps) appScrolltriger_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appScrolltriger_toPropertyKey(arg) { var key = appScrolltriger_toPrimitive(arg, "string"); return appScrolltriger_typeof(key) === "symbol" ? key : String(key); }
function appScrolltriger_toPrimitive(input, hint) { if (appScrolltriger_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appScrolltriger_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appScrolltriger_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appScrolltriger_assertThisInitialized(self); }
function appScrolltriger_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppScrolltriger = /*#__PURE__*/function (_Core) {
  _inherits(AppScrolltriger, _Core);
  var _super = _createSuper(AppScrolltriger);
  function AppScrolltriger() {
    appScrolltriger_classCallCheck(this, AppScrolltriger);
    return _super.apply(this, arguments);
  }
  appScrolltriger_createClass(AppScrolltriger, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
    ...
    */
    ...
    value: function loadHandler() {
      gsap.registerPlugin(ScrollTrigger_ScrollTrigger);

      /* ここでスクロールとブラウザイベントを有効にする */
      this.enableScroll();
      gsap.utils.toArray('.js-trigger').forEach(function (_this) {
        gsap.fromTo(_this, {
          y: '60px',
          autoAlpha: 0
        }, {
      ...
      gsap.utils.toArray('.js-trigger-reverse').forEach(function (_this) {
        gsap.fromTo(_this, {
          y: '60px',
          autoAlpha: 0
        }, {
      ...
      gsap.utils.toArray('.js-trigger-scrub').forEach(function (_this) {
        gsap.fromTo(_this, {
          y: '60px',
          autoAlpha: 0
        }, {
      ...
      gsap.utils.toArray('.js-trigger-bg').forEach(function (_this) {
        gsap.fromTo(_this, {
          y: '250px'
        }, {
          y: '-250px',
      ...
      ScrollTrigger_ScrollTrigger.batch('.js-trigger-batch div', {
        batchMax: 3,
      ...
      gsap.utils.toArray('.js-trigger-pin').forEach(function (_this) {
        console.info($(_this.querySelector('.obj')));
        var _x = window.innerWidth - _this.querySelector('.obj').clientWidth;
