...
Tween.version = Timeline.version = gsap_core_gsap.version = "3.11.3";
_coreReady = 1;
_windowExists() && _wake();
...
;// CONCATENATED MODULE: ./src/scripts/libs/util.js
  ...
  _createClass(UserAgent, [{
    ...
    value: function initialize() {
      ...
      return new Promise(function (resolve, reject) {
        var setOther = function setOther() {
          /* Resolution  ---------------- */
          ...
          /* Touch  ---------------- */
          if (_this.USER.isMobile) _this.USER.isTouch = true;else {
        ...
        if (navigator.userAgentData) {
          ...
          var setUA = /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var uaData, highEntropyValues, _iterator, _step, el;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      uaData = navigator.userAgentData; // getHighEntropyValues()メソッドには取得したい情報を配列の引数で渡す
                      _context.next = 3;
                      return uaData.getHighEntropyValues(["platform",
                      // os
                      "platformVersion",
                      // osVersion
                      "model" // mobile model
                    ...
                    case 3:
                      ...
                      /* OS  ---------------- */
                      _iterator = _createForOfIteratorHelper(clientHintsList.os);
                      try {
                      ...
                      /* Browser  ---------------- */
                      highEntropyValues.brands.find(function (item, i) {
                        var _iterator2 = _createForOfIteratorHelper(clientHintsList.browser),
                          _step2;
                        try {
          ...
          /* Device  ---------------- */
          if (_this.USER.agent.indexOf('ipad') != -1) _this.USER.device = 'ipad';else if (_this.USER.agent.indexOf('ipod') != -1) _this.USER.device = 'ipod';else if (_this.USER.agent.indexOf('iphone') != -1) _this.USER.device = 'iphone';else if (_this.USER.agent.indexOf('windows') != -1 && _this.USER.agent.indexOf('touch') != -1 && _this.USER.agent.indexOf('tablet pc') == -1) _this.USER.device = 'windowstablet';else if (_this.USER.agent.indexOf('windows') != -1 && _this.USER.agent.indexOf('phone') != -1) _this.USER.device = 'windowsphone';else if (_this.USER.agent.indexOf('android') != -1 && _this.USER.agent.indexOf('mobile') != -1) _this.USER.device = 'androidphone';else if (_this.USER.agent.indexOf('android') != -1 && _this.USER.agent.indexOf('mobile') == -1) _this.USER.device = 'androidtablet';else if (_this.USER.agent.indexOf('kindle') != -1) _this.USER.device = 'kindle';else {
          ...
          if (_this.USER.agent.indexOf('windows') != -1) {
            ...
            if (_this.USER.agent.match(/win(dows )?nt 10\.0/)) _this.USER.osVersion = 'windows10';else if (_this.USER.agent.match(/win(dows )?nt 6\.3/)) _this.USER.osVersion = 'windows8';else if (_this.USER.agent.match(/win(dows )?nt 6\.2/)) _this.USER.osVersion = 'windows8';else if (_this.USER.agent.match(/win(dows )?nt 6\.1/)) _this.USER.osVersion = 'windows7';else if (_this.USER.agent.match(/win(dows )?nt 6\.0/)) _this.USER.osVersion = 'windowsVista';
          ...
          /* Browser  ---------------- */
          if (_this.USER.agent.indexOf('edge') != -1) _this.USER.browser = 'edge';else if (_this.USER.agent.indexOf('ybrowser') != -1) _this.USER.browser = 'ybrowser';else if (_this.USER.agent.indexOf('chrome') != -1 && _this.USER.agent.indexOf('opr') == -1) {
            ...
            if (_this.USER.ie.indexOf('msie 6.') != -1) _this.USER.browserVersion = 6;else if (_this.USER.ie.indexOf('msie 7.') != -1) _this.USER.browserVersion = 7;else if (_this.USER.ie.indexOf('msie 8.') != -1) _this.USER.browserVersion = 8;else if (_this.USER.ie.indexOf('msie 9.') != -1) _this.USER.browserVersion = 9;else if (_this.USER.ie.indexOf('msie 10.') != -1) _this.USER.browserVersion = 10;
...
var MediaQueries = /*#__PURE__*/function () {
  function MediaQueries(tb, sp, core) {
    _classCallCheck(this, MediaQueries);
    //this.device = '',
    this.mqlTb = '', this.mqlSp = '';
  }
  _createClass(MediaQueries, [{
    key: "initialize",
    value: function initialize(tb, sp, core) {
      var that = this;
      ...
      window.matchMedia('screen and (max-width:' + this.mqlTb + 'px)').addListener(function () {
        that.responsive(core);
      });
      window.matchMedia('screen and (max-width:' + this.mqlSp + 'px)').addListener(function () {
        that.responsive(core);
      });
    ...
    key: "responsive",
    value: function responsive(core) {
...
;
;// CONCATENATED MODULE: ./src/scripts/libs/functions.js
/*
...
*/
var setPopupWin = function setPopupWin(core) {
  var winName = 'popup_win'; /* ウィンドウネーム */
  var winWidth = 700; // 横幅
  ...
  if (core.mql === 'pc') {
    ...
    for (var i = 0; i < popup.length; i++) {
      popup[i].addEventListener('click', function (e) {
        e.preventDefault();
        var w = window.open(this.href, winName, 'toolbar=0,location=0,status=0,menubar=0,scrollbars=yes,resizable=1,width=' + winWidth + ',height=' + winHeight);
        w.focus();
      });
    }
    ;
    ...
    for (var _i = 0; _i < popup.length; _i++) {
      popup[_i].classList.remove('js-popup');
      popup[_i].setAttribute('target', '_blank');
    }
  }
};
...
*/
var setScrollTo = function setScrollTo(core) {
  var trigger = document.querySelectorAll('a[href*="#"],area[href*="#"]');
  var scrollSpeed = .5; // スクロール速度
  var targetOffset;
  var scroll = function scroll(hash) {
...
var setAccordion = function setAccordion() {
  var toggleButton = document.querySelectorAll('.js-accorBtn');
  for (var i = 0; i < toggleButton.length; i++) {
    toggleButton[i].addEventListener('click', function () {
      var target = this.nextElementSibling;
      var result = target.classList.contains('open');
      if (result) {
        /* 閉じる */
...
*/
var setTelCall = function setTelCall(core) {
  var telCall = document.querySelectorAll('.js-telCall'),
    txt,
    num;
  //console.info(core.USER)
  if (core.USER.isMobile) {
    for (var i = 0; i < telCall.length; i++) {
...
/*
  マウス追従/setCrsl/  -----------------------------------------------
*/
var setCrsl = function setCrsl(core) {
  var crsl = document.createElement('div');
  crsl.id = 'crsl';
  document.body.appendChild(crsl);
  var crslArea = document.querySelectorAll('.js-crslArea');
  ...
  if (!core.USER.isMobile) {
    ...
    for (var i = 0; i < crslArea.length; i++) {
      console.info(i, crslArea);
      crslArea[i].addEventListener('mouseover', function () {
        crsl.classList.add('over');
      });
      crslArea[i].addEventListener('mouseout', function () {
...
;// CONCATENATED MODULE: ./src/scripts/libs/core.js
...
function core_regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ core_regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == core_typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator.return && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) { if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; } return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) { keys.push(key); } return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) { "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); } }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, catch: function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || core_unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return core_arrayLikeToArray(arr); }
...
function core_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, core_toPropertyKey(descriptor.key), descriptor); } }
...
var Core = /*#__PURE__*/function () {
  function Core() {
    ...
    this.setGlobal(), this.scroll = 'onwheel' in document ? 'wheel' : 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', this.ua = new UserAgent(), this.USER = {}, this.mediaQueries = new MediaQueries(), this.transitionEnd = 'webkitTransitionEnd mozTransitionEnd oTransitionEnd transitionend', this.animationEnd = 'webkitAnimationEnd mozAnimationEnd oAnimationEnd animationend', this.mql = '', this.win = {
      width: 0,
      height: 0,
      scrollTop: 0,
      scrollBottom: 0,
  ...
  core_createClass(Core, [{
    key: "initialize",
    value: function () {
      var _initialize = core_asyncToGenerator( /*#__PURE__*/core_regeneratorRuntime().mark(function _callee(tb, sp) {
        var _document$documentEle,
          _this = this;
        return core_regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.ua.initialize();
              case 2:
                ...
                /* browser情報をhtmlへ */
                (_document$documentEle = document.documentElement.classList).add.apply(_document$documentEle, _toConsumableArray(this.USER.css));
                ...
                window.addEventListener('scroll', function () {
                  _this.scrollEvents(_this);
                }, false);
                window.addEventListener('resize', function () {
                  _this.resetEvents(_this);
                }, false);
                this.loadEvents();
              case 10:
              case "end":
    ...
    value: function scrollEvents() {
      ...
      this.win.timer = setTimeout(function () {
        _this2.win.isScrolling = false;

        /* 個別JSハンドラ */
        if (typeof _this2.scrollHandler !== 'undefined') {
    ...
    value: function disableScroll() {
      window.addEventListener(this.scroll, this.disableEvents, {
        passive: false
      });
    }
    ...
    value: function enableScroll() {
      ...
      window.removeEventListener(this.scroll, this.disableEvents, {
        passive: false
      });
    }
  }]);
...
;// CONCATENATED MODULE: ./src/scripts/appFilter.js
function appFilter_typeof(obj) { "@babel/helpers - typeof"; return appFilter_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appFilter_typeof(obj); }
function appFilter_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appFilter_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appFilter_toPropertyKey(descriptor.key), descriptor); } }
function appFilter_createClass(Constructor, protoProps, staticProps) { if (protoProps) appFilter_defineProperties(Constructor.prototype, protoProps); if (staticProps) appFilter_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appFilter_toPropertyKey(arg) { var key = appFilter_toPrimitive(arg, "string"); return appFilter_typeof(key) === "symbol" ? key : String(key); }
function appFilter_toPrimitive(input, hint) { if (appFilter_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appFilter_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appFilter_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appFilter_assertThisInitialized(self); }
function appFilter_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppFilter = /*#__PURE__*/function (_Core) {
  _inherits(AppFilter, _Core);
  var _super = _createSuper(AppFilter);
  function AppFilter() {
    appFilter_classCallCheck(this, AppFilter);
    return _super.apply(this, arguments);
  }
  appFilter_createClass(AppFilter, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
    ...
    */
    ...
    value: function loadHandler() {
      var _this2 = this;
      $('.loader').addClass('fo').on(this.animationEnd, function () {
        $('.loader').addClass('hdn').off(_this2.animationEnd);
        ...
        /*
           rgbFlicker ---------------------------------------------
         */
        var rgbDom = document.querySelector('.unko > li:nth-child(1) img');
        var rgb = document.querySelectorAll('#rgbFlicker > feOffset');
        var rgbTl = gsap.timeline().pause().add('scene1');
        gsap.utils.toArray(rgb).forEach(function (_this) {
          rgbTl.to(_this, {
            repeat: -1,
            duration: .2,
        ...
        rgbDom.addEventListener('mouseover', function (_this) {
          rgbTl.play();
        });
        rgbDom.addEventListener('mouseout', function (_this) {
          rgbTl.pause();
          gsap.utils.toArray(rgb).forEach(function (_this) {
            gsap.set(_this, {
              onComplete: function onComplete() {
        ...
        /*
           noise ---------------------------------------------
         */
        var noiseDom = document.querySelector('.unko > li:nth-child(2) img');
        var turbulence = document.querySelector('#noise > feTurbulence');
        var displacementMap = document.querySelector('#noise > feDisplacementMap');
        var _scale = {
          value: null
        };
        var _baseFrequency = {
        ...
        var noiseTl = gsap.timeline().pause().add('scene1').fromTo(_scale, {
          value: 0
        }, {
          value: 140,
          duration: .3,
        ...
        var noiseTl2 = gsap.timeline().pause().add('scene1').to(_baseFrequency, {
          repeat: -1,
          duration: .3,
          ease: 'Power4.easeIn',
          onUpdate: function onUpdate() {
        ...
        noiseDom.addEventListener('mouseover', function (_this) {
          noiseTl.play();
          //noiseTl2.play();
        });

        noiseDom.addEventListener('mouseout', function (_this) {
          noiseTl2.pause();
          noiseTl.reverse();
        });
        ...
        /*
           toneChange ---------------------------------------------
         */
        var toneChangeDom = document.querySelector('.unko > li:nth-child(3) img');
        var feFunc = document.querySelectorAll('#duotone .feFunc');
        var color = {
          r: '0 1',
          g: '0 1',
          b: '0 1'
        };
        var toneChangeTl = gsap.timeline();
        var toneChangeGo = function toneChangeGo() {
          toneChangeTl.add('scene1').fromTo('#duotone feFuncR', {
            attr: {
        ...
        toneChangeDom.addEventListener('mouseover', function (_this) {
          toneChangeGo();
        });
        toneChangeDom.addEventListener('mouseout', function (_this) {
          toneChangeTl.pause();
        });
        ...
        /*
           handWriting ---------------------------------------------
         */
        var handWritingDom = document.querySelector('.unko > li:nth-child(4) img');
        var turbulence2 = document.querySelector('#handWriting > feTurbulence');
        var displacementMap2 = document.querySelector('#handWriting > feDisplacementMap');
        var _scale2 = {
          value: null
        };
        var _baseFrequency2 = {
        ...
        var handWritingTl = gsap.timeline().pause().add('scene1').to(displacementMap2, {
          duration: 1,
          repeat: -1,
          /*
                    yoyo: true,
        ...
        handWritingDom.addEventListener('mouseover', function (_this) {
          handWritingTl.play();
        });
        handWritingDom.addEventListener('mouseout', function (_this) {
          handWritingTl.pause();
        });
        ...
        /*
           nega ---------------------------------------------
         */
        var negaDom = document.querySelector('.unko > li:nth-child(5) img');
        var negaRgb = document.querySelectorAll('#nega .feFunc');
        var negaTl = gsap.timeline().pause();
        negaTl.add('scene1').to(negaRgb, {
          duration: .2,
          attr: {
        ...
        negaDom.addEventListener('mouseover', function (_this) {
          negaTl.play();
        });
        negaDom.addEventListener('mouseout', function (_this) {
          negaTl.reverse();
        });
        ...
        /*
           morphology ---------------------------------------------
         */
        var morphoDom = document.querySelector('.unko > li:nth-child(6) img');
        var morphology = document.querySelector('#morphology feMorphology');
        var gaussianBlur = document.querySelector('#morphology feGaussianBlur');
        var morphoTl = gsap.timeline().pause();
        morphoTl.add('scene1').to(morphology, {
          duration: .6,
        ...
        morphoDom.addEventListener('mouseover', function (_this) {
          morphoTl.play();
        });
        morphoDom.addEventListener('mouseout', function (_this) {
          morphoTl.reverse();
        });
        ...
        /*
           distantLight ---------------------------------------------
         */
        var distantLightDom = document.querySelector('.unko > li:nth-child(7) img');
        var distantLight = document.querySelector('#distantLight feDistantLight');
        var distantLightTl = gsap.timeline().pause();
        distantLightTl.add('scene1').to(distantLight, {
          duration: .5,
          yoyo: true,
          ease: 'SlowMo.ease',
          attr: {
            azimuth: function azimuth() {
              return '-30';
            }
          }
        }, 'scene1').to(distantLight, {
          duration: .25,
          ease: 'Power4.easeOut',
          attr: {
        ...
        distantLightDom.addEventListener('mouseover', function (_this) {
          distantLightTl.play();
        });
        distantLightDom.addEventListener('mouseout', function (_this) {
        ...
        /*
           offset ---------------------------------------------
         */
        var offsetDom = document.querySelector('.unko > li:nth-child(8) img');
        var offset1 = document.querySelector('#offset .offset1');
        var offset2 = document.querySelector('#offset .offset2');
        var offsetTl = gsap.timeline().pause();
        offsetTl.add('scene1').to(offset1, {
          duration: .5,
          ease: 'Elastic.easeOut',
          attr: {
            dx: function dx() {
        ...
        offsetDom.addEventListener('mouseover', function (_this) {
          offsetTl.play();
        });
        offsetDom.addEventListener('mouseout', function (_this) {
          offsetTl.reverse();
        });
      });
    }
