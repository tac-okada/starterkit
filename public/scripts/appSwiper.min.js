...
;// CONCATENATED MODULE: ./src/scripts/appSwiper.js
function appSwiper_typeof(obj) { "@babel/helpers - typeof"; return appSwiper_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appSwiper_typeof(obj); }
function appSwiper_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appSwiper_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appSwiper_toPropertyKey(descriptor.key), descriptor); } }
function appSwiper_createClass(Constructor, protoProps, staticProps) { if (protoProps) appSwiper_defineProperties(Constructor.prototype, protoProps); if (staticProps) appSwiper_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appSwiper_toPropertyKey(arg) { var key = appSwiper_toPrimitive(arg, "string"); return appSwiper_typeof(key) === "symbol" ? key : String(key); }
function appSwiper_toPrimitive(input, hint) { if (appSwiper_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appSwiper_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appSwiper_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appSwiper_assertThisInitialized(self); }
function appSwiper_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppSwiper = /*#__PURE__*/function (_Core) {
  _inherits(AppSwiper, _Core);
  var _super = _createSuper(AppSwiper);
  function AppSwiper() {
    appSwiper_classCallCheck(this, AppSwiper);
    return _super.apply(this, arguments);
  }
  appSwiper_createClass(AppSwiper, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
    ...
    */
    ...
    value: function setSwiper() {
      ...
      var swiper = new core('.swiper', {
        ...
        // 余白px
        effect: 'slide',
        // 演出："slide", "fade"(フェード), "cube"(キューブ回転), "coverflow"(カバーフロー) または "flip"(平面回転)
        navigation: {
          nextEl: '.swiper-button-next',
          prevEl: '.swiper-button-prev'
        },
        ...
        on: {
          ...
          slideChange: function slideChange() {// スライドが切り替わったとき※loop時は注意
          ...
          slideChangeTransitionStart: function slideChangeTransitionStart() {// 切り替わりアニメーション開始
            //console.info('slideChangeTransitionStart')
          },
          slideChangeTransitionEnd: function slideChangeTransitionEnd() {// 切り替わりアニメーション終了
            //console.info('slideChangeTransitionEnd')
          },
          imagesReady: function imagesReady() {// スライドの画像の読み込みが完了したとき(※スライド内にimgタグがある場合のみ)
            // 任意の処理を実行
          }
        }
      });
