...
var UserAgent = /*#__PURE__*/function () {
  ...
  _createClass(UserAgent, [{
    ...
    value: function initialize() {
      /* Device  ---------------- */
      if (this.USER.agent.indexOf('ipad') != -1) this.USER.device = 'ipad';else if (this.USER.agent.indexOf('ipod') != -1) this.USER.device = 'ipod';else if (this.USER.agent.indexOf('iphone') != -1) this.USER.device = 'iphone';else if (this.USER.agent.indexOf('windows') != -1 && this.USER.agent.indexOf('touch') != -1 && this.USER.agent.indexOf('tablet pc') == -1) this.USER.device = 'windowstablet';else if (this.USER.agent.indexOf('windows') != -1 && this.USER.agent.indexOf('phone') != -1) this.USER.device = 'windowsphone';else if (this.USER.agent.indexOf('android') != -1 && this.USER.agent.indexOf('mobile') != -1) this.USER.device = 'androidphone';else if (this.USER.agent.indexOf('android') != -1 && this.USER.agent.indexOf('mobile') == -1) this.USER.device = 'androidtablet';else if (this.USER.agent.indexOf('kindle') != -1) this.USER.device = 'kindle';else this.USER.device = 'desktop';
      ...
      if (this.USER.agent.indexOf('windows') != -1) {
        ...
        if (this.USER.agent.match(/win(dows )?nt 10\.0/)) this.USER.osVersion = 'windows10';else if (this.USER.agent.match(/win(dows )?nt 6\.3/)) this.USER.osVersion = 'windows8';else if (this.USER.agent.match(/win(dows )?nt 6\.2/)) this.USER.osVersion = 'windows8';else if (this.USER.agent.match(/win(dows )?nt 6\.1/)) this.USER.osVersion = 'windows7';else if (this.USER.agent.match(/win(dows )?nt 6\.0/)) this.USER.osVersion = 'windowsVista';
        ...
        if (this.USER.osVersion > 4 && this.USER.osVersion < 4.4) this.USER.osCodeName = 'jellybean';else if (this.USER.osVersion >= 4.4 && this.USER.osVersion < 5) this.USER.osCodeName = 'kitkat';else if (this.USER.osVersion >= 5 && this.USER.osVersion < 6) this.USER.osCodeName = 'lollipop';else if (this.USER.osVersion >= 6 && this.USER.osVersion < 7) this.USER.osCodeName = 'marshmallow';else if (this.USER.osVersion >= 7 && this.USER.osVersion < 8) this.USER.osCodeName = 'nougat';else if (this.USER.osVersion >= 8 && this.USER.osVersion < 9) this.USER.osCodeName = 'oreo';else if (this.USER.osVersion >= 9 && this.USER.osVersion < 10) this.USER.osCodeName = 'pie';else if (this.USER.osVersion >= 10 && this.USER.osVersion < 11) this.USER.osCodeName = 'Q';else if (this.USER.osVersion >= 11 && this.USER.osVersion < 12) this.USER.osCodeName = 'R';else if (this.USER.osVersion >= 12 && this.USER.osVersion < 13) this.USER.osCodeName = 'S';
      ...
      /* Browser  ---------------- */
      if (this.USER.agent.indexOf('edge') != -1) this.USER.browser = 'edge';else if (this.USER.agent.indexOf('ybrowser') != -1) this.USER.browser = 'ybrowser';else if (this.USER.agent.indexOf('chrome') != -1 && this.USER.agent.indexOf('opr') == -1) {
        ...
        if (this.USER.ie.indexOf('msie 6.') != -1) this.USER.browserVersion = 6;else if (this.USER.ie.indexOf('msie 7.') != -1) this.USER.browserVersion = 7;else if (this.USER.ie.indexOf('msie 8.') != -1) this.USER.browserVersion = 8;else if (this.USER.ie.indexOf('msie 9.') != -1) this.USER.browserVersion = 9;else if (this.USER.ie.indexOf('msie 10.') != -1) this.USER.browserVersion = 10;
      ...
      /* Engine  ---------------- */
      if (this.USER.agent.indexOf('applewebkit') != -1) this.USER.engine = 'webkit';else if (this.USER.agent.indexOf('gecko') != -1) this.USER.engine = 'gecko';else if (this.USER.agent.indexOf('trident') != -1) this.USER.engine = 'trident';else if (this.USER.agent.indexOf('presto') != -1) this.USER.engine = 'presto';

      /* Touch  ---------------- */
      if (this.USER.device != 'desktop') this.USER.isTouch = true;else {
...
var Core = /*#__PURE__*/function () {
  ...
  core_createClass(Core, [{
    key: "initialize",
    value: function initialize(tb, sp) {
      var _this = this;
      /* 基本情報セット */
      ...
      $btn.each(function (i) {
        ...
        $(this).off().on({
          'click': function click(event) {
            ...
            if (that.state.response) {
              console.info(_num, _player_num, youtubeAPI_youtubeAPI.ytPlayer);
              that.openEvent({
                target: $(this),
                event: 'click',
                num: _num,
