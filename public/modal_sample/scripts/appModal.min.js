...
var youtubeAPI_youtubeAPI = {
  ...
  */
  setYoutube: function setYoutube(flg) {
    if (flg) {
      this.autoPlay = 1;
    }
    if (this.flgYtTag) {
  ...
  embedYoutube: function embedYoutube(_num) {
    ...
    // width：プレーヤーの幅、height：プレーヤーの高さ、YouTubeのID
    {
      ...
      playerVars: {
        ...
        // autoPlayはiOSで機能しないので、onPlayerReadyでかつsetTimeoutでやる
        mute: this.autoPlay,
        // iOSで自動再生時必須。setVolume(0)だと自動再生しない
        showinfo: 0,
        loop: 0,
        controls: 1
      },
...
function _defineProperty(obj, key, value) { key = modal_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    _defineProperty(this, "animationEvents", {
      open: function open(that, obj) {
        ...
        that.$bg.removeClass('hdn out').addClass('active in').on(that.core.animationEnd, function () {
          that.$bg.off(that.core.animationEnd);
          if (obj.bg_click) {
            /* パラメータ「bg_click」がtrueの場合 */
            that.$close_btn.removeClass('hdn out').addClass('active in').on(that.core.transitionEnd, function () {
          ...
          that.proto.$obj.removeClass('hdn out').addClass('in').on(that.core.animationEnd, function () {
    ...
    this.core = {}, this.$window = $(window), this.$html = $('html'), this.$btn = $('.js-modalOpen'), this.$contents = $('.modal_contents'), this.$body = $('body'), this.iframepath = '', this.autoPlay = false, /* Youtube autoPlay */
  ...
  modal_createClass(Modal, [{
    key: "initialize",
    value: function initialize(core) {
      this.core = core;
      this.setTrigger();
    ...
    function setTrigger() {
      ...
      var that = this;
      $btn.each(function (i) {
        var _type = $(this).attr('data-modal').split('__')[1],
        ...
        if (!_flg_exist) {
          ...
          /* iframe個別埋め込みに変更 */
          that.proto.contents[Number($(this).attr('data-modal').split('__')[0]) - 1] = String() + '<div class="modal_contents modal_' + Number($(this).attr('data-modal').split('__')[0]) + ' modal_' + _type + '">' + _cts_txt_in + '</div>';
          ...
          'click': function click(event) {
            ...
            if (!that.proto.setdom[Number($(this).attr('data-modal').split('__')[0]) - 1]) {
              ...
              if (_type === 'yt') {
                ...
                youtubeAPI_youtubeAPI.setYoutube(that.autoPlay);
              }
            }
            if (that.state.response) {
...
;
;// CONCATENATED MODULE: ./src/modal_sample/scripts/appModal.js
function appModal_typeof(obj) { "@babel/helpers - typeof"; return appModal_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, appModal_typeof(obj); }
function appModal_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function appModal_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, appModal_toPropertyKey(descriptor.key), descriptor); } }
function appModal_createClass(Constructor, protoProps, staticProps) { if (protoProps) appModal_defineProperties(Constructor.prototype, protoProps); if (staticProps) appModal_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function appModal_toPropertyKey(arg) { var key = appModal_toPrimitive(arg, "string"); return appModal_typeof(key) === "symbol" ? key : String(key); }
function appModal_toPrimitive(input, hint) { if (appModal_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (appModal_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (appModal_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return appModal_assertThisInitialized(self); }
function appModal_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var AppModal = /*#__PURE__*/function (_Core) {
  _inherits(AppModal, _Core);
  var _super = _createSuper(AppModal);
  function AppModal() {
    appModal_classCallCheck(this, AppModal);
    return _super.apply(this, arguments);
  }
  appModal_createClass(AppModal, [{
    key: "scrollHandler",
    value:
    /*
      使用可能な定数・変数一覧  -----------------------------------------------
