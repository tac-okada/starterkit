    ...
    return new Promise(function (resolve, reject) {
      ...
      if (navigator.userAgentData) {
        ...
        const setUA = async () => {
          ...
          const highEntropyValues = await uaData.getHighEntropyValues(["platform",
          // os
          "platformVersion",
          // osVersion
          "model" // mobile model
...
const setCopy = core => {
  ...
  function copyTxt(e) {
    ...
    let compTl = gsap.timeline().pause().add('scene1').fromTo(comp, {
      y: '5px'
    }, {
      y: 0,
      autoAlpha: 1,
...
class Core {
  constructor() {
    this.setGlobal(), this.scroll = 'onwheel' in document ? 'wheel' : 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', this.ua = new UserAgent(), this.USER = {}, this.mediaQueries = new MediaQueries(), this.mql = '', this.win = {
      width: 0,
      height: 0,
      scrollTop: 0,
      scrollBottom: 0,
...
class Modal {
  constructor() {
    this.core = {}, this.btn = '', this.eventListeners = [], this.body = document.body, this.iframepath = '', this.autoPlay = false, /* Youtube autoPlay */
    this.bg = '', this.closeBtn = '', this.iframe = [], this.dom = [], this.firstClick = true, this.state = {
      response: false,
      width: 0,
      height: 0,
      scrollPos: 0
  ...
  initialize(core) {
    ...
    that.proto.bg = that.setHtml({
      type: 'bg'
    });
    that.proto.closeBtn = that.setHtml({
      type: 'close'
    });
  ...
  animationEvents = {
    open(that, obj) {
      ...
      function openEventBg(event) {
        ...
        that.proto.obj.addEventListener('animationend', openEventObj, {
          once: true
        });
      ...
      //console.time('open');
      that.bg.addEventListener('animationend', openEventBg, {
        once: true
      });
    },
    close(that /* , _obj */) {
      ...
      const setupEvent = target => {
        ...
        target.addEventListener('animationend', closeEvent, {
          once: true
        });
      };
      setupEvent(that.bg);
    ...
    for (let i = 0; i < that.btn.length; i++) {
      ...
      function clickEvent(event) {
        ...
        if (!that.proto.setdom[Number(that.btn[i].getAttribute('data-modal').split('__')[0]) - 1]) {
          ...
          if (_type === 'yt') {
            youtubeAPI_youtubeAPI.playerNum = that.btn[i].getAttribute('data-ytnum') - 1;
      ...
      if (i + 1 === that.btn.length) {
        youtubeAPI_youtubeAPI.youtubeData.sort((a, b) => {
          return a.num - b.num;
        });
      }
    }
  ...
  setCloseBtn = {
      ...
      const setEvent = target => {
        ...
        for (let i = 0; i < closeBtn.length; i++) {
          ...
          closeBtn[i].addEventListener('click', {
            that: that,
            obj: obj,
            handleEvent: that.setCloseBtn.setupEvent
          });
        }
      };
    ...
    setupEvent(e) {
      ...
      if (this.that.state.response) {
        ...
        if (this.obj.type === 'yt') {
          that.setPlayer({
            player: youtubeAPI_youtubeAPI.ytPlayer[this.obj.player_num - 1],
            event: 'stop'
          });
        }
...
;
;// CONCATENATED MODULE: ./src/sample/modal/scripts/appModal.js
