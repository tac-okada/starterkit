...
;// CONCATENATED MODULE: ./src/sample/filter/scripts/appFilter.js
  ...
  */
  ...
  loadHandler() {
    ...
    function setFilter() {
      ...
      let noiseTl = gsap.timeline().pause().add('scene1').fromTo(_scale, {
        value: 0
      }, {
        value: 140,
        duration: .3,
      ...
      let noiseTl2 = gsap.timeline().pause().add('scene1').to(_baseFrequency, {
        repeat: -1,
        duration: .3,
        ease: 'Power4.easeIn',
        onUpdate: function () {
      ...
      let handWritingTl = gsap.timeline().pause().add('scene1').to(displacementMap2, {
        duration: 1,
        repeat: -1,
        /*
                  yoyo: true,
