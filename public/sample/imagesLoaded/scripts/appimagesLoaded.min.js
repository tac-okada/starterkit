...
( function( window, factory ) {
  ...
  if (  true && module.exports ) {
    // CommonJS
    module.exports = factory( window, __webpack_require__(7158) );
  } else {
    // browser global
...
;// CONCATENATED MODULE: ./src/sample/imagesLoaded/scripts/appImagesLoaded.js
...
class AppImagesLoaded extends Core {
  ...
  */
  ...
  loadHandler() {
    ...
    let percentage = 0;
    let imgCount = 0;
    let imgLoad = imagesloaded_default()('body');
