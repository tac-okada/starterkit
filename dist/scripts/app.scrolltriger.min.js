...
var Observer_gsap,
  ...
  if (Observer_gsap && typeof document !== "undefined" && document.body) {
    ...
    _clamp = Observer_gsap.utils.clamp;
...
var Observer = /*#__PURE__*/function () {
  ...
  _proto.init = function init(vars) {
    _coreInitted || _initCore(Observer_gsap) || console.warn("Please gsap.registerPlugin(Observer)");
...
;// CONCATENATED MODULE: ./src/scripts/app.scrolltriger.js

gsap.registerPlugin(ScrollTrigger_ScrollTrigger);
app.scrolltriger = function () {
  var setScrollAnimation = function setScrollAnimation() {
