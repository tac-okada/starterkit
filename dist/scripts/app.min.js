...
( function( factory ) {
	...
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(755) ], __WEBPACK_AMD_DEFINE_RESULT__ = (function( jQuery ) {
...
var Power0 = _easeMap.Power0,
    ...
    gsap_core_Power2 = _easeMap.Power2,
...
var jquery_migrate = __webpack_require__(752);
...
var setPopupWin = function setPopupWin() {
...
var setToggle = function setToggle() {
  var toggleButton = document.querySelectorAll('.js-toggleBtn');
...
var Core = /*#__PURE__*/function () {
  function Core() {
    ...
    this.appMethodes = ['core', 'USER', 'win', 'mql', 'transitionEnd', 'animationEnd', 'initialize'], this.pages = [], this.scroll = 'onwheel' in document ? 'wheel' : 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', this.ua = new UserAgent(),
  ...
  core_createClass(Core, [{
    ...
    value: function setPages() {
      ...
      Object.keys(app).map(function (key) {
        ...
        for (var i = 0, len = that.appMethodes.length; i <= len; i++) {
    ...
    value: function scrollEvents() {
      ...
      this.win.timer = setTimeout(function () {
        ...
        for (var i = 0; i < _this2.pages.length; i++) {
          if (typeof app[_this2.pages[i]] !== 'undefined') {
            app[_this2.pages[i]].scrollHandler();
          }
        }
      }, 10);
    }
    ...
    value: function disableScroll() {
      window.addEventListener(this.scrollEvents, this.disableEvents, {
        passive: false
      });
    }
    ...
    value: function enableScroll() {
      window.removeEventListener(this.scrollEvents, this.disableEvents, {
        passive: false
      });
    }
  }]);
...
app = function () {
  ...
  */
  ...
  /*
    初期化  -----------------------------------------------
  */
  var initialize = function initialize(tb, sp) {
